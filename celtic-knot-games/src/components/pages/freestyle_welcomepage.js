...
function FreestyleWelcomePage() {
    ...
    const startGame = () => {
        ...
        navigate('/freestyle_gamepage', { state: { gridWidth: width, gridHeight: height, colorComponent: colorComponent } });;  // navigate to playboard
    };
                ...
                <div className="content">
                    <div className="settings">
                        ...
                        <div className="radio-container">
                            ...
                            <span className="tooltip" title="A component is an individual knot on the board"> 
